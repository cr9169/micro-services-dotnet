/// <summary>
/// Custom exception for repository-level errors in the CatalogItemRepository.
/// This exception should be thrown when a database or data access error occurs.
/// </summary>
public class CatalogItemRepositoryException : Exception
{
    /// <summary>
    ...
    public CatalogItemRepositoryException(string message)
        : base(message) { }
    ...
    public CatalogItemRepositoryException(string message, Exception innerException)
